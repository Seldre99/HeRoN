...
def train_dqn(episodes, model_save, batch_size=32, load_model_path=None):
...
if __name__ == "__main__":
    ...
    # Train the agent
    rewards, agent_wins, enemy_wins, moves, success_rate, match_score = train_dqn(episodes=1000, model_save="")
