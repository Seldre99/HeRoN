...
# Main loop testing
def test_ppo(model_path, episodes):
    ...
    for e in range(episodes):
        ...
        while not done:
            ...
            action = agent.act_deterministic(state, mask)
...
def export_success_rate(success_rate):
    ...
    df.to_csv('test_success_rate_model_PPO_5_1000.csv', index=False)
...
if __name__ == "__main__":
    ...
    # Train the agent
    rewards, agent_wins, enemy_wins, moves, success_rate, match = test_ppo(f"C:/Users/andre/OneDrive/Desktop/Università/tesi magistrale/ppo/model_6", episodes=1000)
