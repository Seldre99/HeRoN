...
from classes.bt_agent import BTAgent
...
def plot_training(rewards, agent_wins, enemy_wins, moves, success_rate, match_score):
    ...
    plt.savefig("Test_reward_BT.png")
    ...
    plt.savefig("Test_cumulative_Win_BT.png")
    ...
    plt.legend()
    plt.savefig("Test_success_rate_BT.png")
...
def export_success_rate(success_rate):
    ...
    df.to_csv('test_success_rate_model_BT_1000.csv', index=False)
...
if __name__ == "__main__":
    ...
    # Train the agent
    rewards, agent_wins, enemy_wins, moves, success_rate, match_score = test_bt(episodes=1000)
